...
export const facts = [
  { date: 'May 29, 2026', title: 'DuckDB 1.5.3 writes Iceberg',
  ...
  { date: 'Feb 19 · Apr 13 · Jun 2026', title: 'The open catalog and open dbt are settled',
    body: 'Apache Polaris became a Top-Level Project; DuckLake 1.0 shipped; dbt Core v2 is Apache 2.0 with no usage limits.' },
];
