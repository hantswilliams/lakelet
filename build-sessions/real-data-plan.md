...
*Amended September 15, 2026 (`trust-round-plan.md` T2): the attach contract's immutable-file assumption is now checked; the detail shows when the files were last verified and names any that changed, with **Register again**.*
