...
> **Decided September 9, 2026: all three accepted.** Shipped the same day as a step 6 amendment: `init` writes `macros/lakelet.sql`, `test_step6_materialisation.py` is the gate, the brief's §7 and the docs are updated. This file is the record of the decision.
