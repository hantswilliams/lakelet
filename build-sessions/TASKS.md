...
Gates as of 2026-09-11 (night): Playwright 21 against six real sidecars (a 20 M-row table, a Moto bucket, a zero-day retention), Vitest 36, `cargo test` 8, core 168 in the container (the S3 files against a real bucket by hand on the Mac); CI green on macOS and Ubuntu for `core`, `app` and Pages.
