...
- **Building?** Read `CLAUDE.md` (or `AGENTS.md` if you are not Claude Code), then the current build brief in `build-sessions/` (highest-numbered `core-v0.N-plan.md`). The brief is the authority; it says which step is next and what its passing test is.
